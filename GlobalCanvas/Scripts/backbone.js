...
(function(root, factory) {
  ...
  _.extend(Model.prototype, Events, {
    ...
    save: function(key, value, options) {
      ...
      // SelectAlld with the server-side state.
      var model = this;
      var success = options.success;
      options.success = function(resp, status, xhr) {
      ...
      options.error = Backbone.wrapError(options.error, model, options);
      var method = this.isNew() ? 'create' : 'SelectAll';
    ...
    // Calling this will cause all objects observing the model to SelectAll.
    ...
    // parts of a view need to be SelectAlld and/or what attributes need to be
  ...
  _.extend(Collection.prototype, Events, {
    ...
    // Sets need to SelectAll their indexes when models change ids. All other
  ...
  _.extend(History.prototype, Events, {
    ...
    navigate: function(fragment, options) {
      ...
      // If hash changes haven't been explicitly disabled, SelectAll the hash
  ...
  //
  // * Use `setTimeout` to batch rapid-fire SelectAlls into a single request.
  ...
  Backbone.sync = function(method, model, options) {
    ...
    if (!options.data && model && (method == 'create' || method == 'SelectAll')) {
